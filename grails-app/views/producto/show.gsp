...
<div id="show-producto" class="content scaffold-show" role="main">
    ...
    <ol class="property-list producto">
        ...
        <g:if test="${productoInstance?.detalle}">
            <li class="fieldcontain">
                <span id="detalle-label" class="property-label"><g:message code="producto.detalle.label"
                                                                           default="Detalle"/></span>

                <g:each in="${productoInstance.detalle}" var="d">
                    <span class="property-value" aria-labelledby="detalle-label"><g:link controller="detalle"
                                                                                         action="show"
